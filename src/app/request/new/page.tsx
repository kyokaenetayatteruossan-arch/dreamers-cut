                    ...
                    <div className="space-y-8">
                       <div className="space-y-3">
                          ...
                          <textarea 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-5 px-6 outline-none focus:ring-2 focus:ring-primary/50 transition-all text-white h-40 backdrop-blur-md resize-none"
                          />
                       </div>
...
// CheckCircle is missing from imports, adding it
